...
class Payroll extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyPayroll(title: 'Payroll'),
    );
  }
}

class MyPayroll extends StatefulWidget {
  MyPayroll({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _MyPayrollState createState() => _MyPayrollState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        child: MainAppBar(title: widget.title, back: "payroll"),
