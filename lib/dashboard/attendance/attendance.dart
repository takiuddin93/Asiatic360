...
class _MyAttendanceState extends State<MyAttendance> {
                        ...
                        child: Stack(
                          children: <Widget>[
                            Container(
                              ...
                              child: Container(
                                margin:
                                    EdgeInsets.only(right: media.width * 0.01),
                                decoration: BoxDecoration(
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return makeDashboardItem(
                                  etaki["data"][index]['attendance_type']
                                      .toString(),
                                  etaki["data"][index]['checkin_time']
                                      .toString(),
                                  etaki["data"].length,
                                  media);
                            },
  ...
  Card makeDashboardItem(String via, String checkin, int index, Size media) {
    return Card(
      elevation: 1.0,
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      ...
                      child: Align(
                        ...
                        child: RichText(
                          text: TextSpan(
                            text: via == '1' ? "Via App" : "Via Fingerprint",
                            style: new TextStyle(
                              color: UniversalVariables.green,
                              fontFamily: 'Poppins',
                              fontWeight: FontWeight.w600,
  ...
  getColor(checkin) {
    checkin < "10:30 AM" ? UniversalVariables.green : UniversalVariables.red;
  }
}
