...
void main() {
  ...
  runApp(MedicalAllowance());
}

class MedicalAllowance extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyMedicalAllowance(title: 'Medical Allowance'),
    );
  }
}

class MyMedicalAllowance extends StatefulWidget {
  MyMedicalAllowance({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _MyMedicalAllowanceState createState() => _MyMedicalAllowanceState();
}

class _MyMedicalAllowanceState extends State<MyMedicalAllowance> {
  List leaveRequest = [
    {'date': '01/01/2020'},
    {'date': '12/12/2019'},
    {'date': '08/11/2019'},
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        child: MainAppBar(title: widget.title, back: "medicalallowance"),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          ...
          Navigator.of(context).push(MaterialPageRoute(
              builder: (BuildContext context) => NewMedicalRequest()));
        },
        icon: Icon(
          Icons.add,
        ),
